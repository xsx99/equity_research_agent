...
INSIDER_COVERAGE_WINDOW_DAYS = int(
    os.getenv("INSIDER_COVERAGE_WINDOW_DAYS", "4")
)
...
GEMINI_FLASH_25_LITE_MODEL_NAME = "gemini-2.5-flash-lite"
OPENROUTER_KIMI_K2_6_MODEL_NAME = "moonshotai/kimi-k2.6"
RESEARCH_MODEL_NAME = os.getenv("RESEARCH_MODEL_NAME", GEMINI_FLASH_25_LITE_MODEL_NAME)
TRADING_MODEL_NAME = os.getenv("TRADING_MODEL_NAME", GEMINI_FLASH_25_LITE_MODEL_NAME)
REFLECTION_MODEL_NAME_RAW = os.getenv("REFLECTION_MODEL_NAME", "").strip()
REFLECTION_MODEL_NAME = REFLECTION_MODEL_NAME_RAW or OPENROUTER_KIMI_K2_6_MODEL_NAME
REFLECTION_MODEL_CONFIGURED = bool(REFLECTION_MODEL_NAME_RAW)
STRATEGY_EVOLUTION_MODEL_NAME_RAW = os.getenv("STRATEGY_EVOLUTION_MODEL_NAME", "").strip()
STRATEGY_EVOLUTION_MODEL_NAME = STRATEGY_EVOLUTION_MODEL_NAME_RAW or OPENROUTER_KIMI_K2_6_MODEL_NAME
STRATEGY_EVOLUTION_MODEL_CONFIGURED = bool(STRATEGY_EVOLUTION_MODEL_NAME_RAW)
TRADING_UNIVERSE_SYMBOLS = os.getenv("TRADING_UNIVERSE_SYMBOLS", "")
PAPER_ACCOUNT_STARTING_EQUITY = float(os.getenv("PAPER_ACCOUNT_STARTING_EQUITY", "1000000"))
...
if APP_ENV in {"prod", "production"} and not REFLECTION_MODEL_CONFIGURED:
    warnings.warn(
        "REFLECTION_MODEL_NAME is not configured; using OPENROUTER_KIMI_K2_6_MODEL_NAME",
        RuntimeWarning,
        stacklevel=1,
    )
