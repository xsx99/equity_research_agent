...
These smoke modes are fixture-only operator checks. Scheduler-facing `preopen`, `manual_review`, and `intraday_refresh` now use live runtimes, while standalone smoke verification should keep using these isolated fixture paths.
