...
These smoke modes are fixture-only operator checks. Scheduler-facing `preopen`, `manual_review`, `intraday_refresh`, and `reflection` now use live runtimes, while standalone smoke verification should keep using these isolated fixture paths.
