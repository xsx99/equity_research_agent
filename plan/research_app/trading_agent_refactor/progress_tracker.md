...
- 2026-06-01: PR 6 implemented `src/trading/paper_stock_broker.py`, `src/trading/portfolio/state.py`, `src/trading/workflows/paper_execution.py`, extended `src/trading/repositories/in_memory.py`, added ORM models in `src/db/models/trading.py`, added Alembic revision `011_paper_stock_broker_portfolio_state.py`, and updated `documents/repo_overview.md`.
...
- 2026-06-02: PR 6 execution path was refactored from local simulated fills to Alpaca paper trading as the execution source of truth. Updated `src/trading/paper_stock_broker.py`, `src/trading/portfolio/state.py`, `src/trading/workflows/paper_execution.py`, `scripts/run_trading_paper_order_smoke.py`, `src/db/models/trading.py`, revision `011_paper_stock_broker_portfolio_state.py`, and `documents/repo_overview.md`.
